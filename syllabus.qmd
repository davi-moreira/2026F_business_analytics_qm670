...
-   Submit on Brightspace before the deadline as a **single PDF** named **HW_X_Group_NN** (X = homework number, NN = your two-digit group number), with all relevant Excel (or other) outputs included and clearly referenced.\
