...
-   **All three are posted on Brightspace in week 1**, so you can work ahead. Each is due at **11:59 pm the evening before the class where its solutions are posted**; the three dates are on the [Schedule](schedule.qmd) page. For HW2 and HW3 that class is the midterm and the final review, so you walk into each review holding the solutions.\
