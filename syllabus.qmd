...
|--------------------------------------|:----------:|
| **Attendance**                       |     5%     |
| **Homework** (3 total, team-based)   |    30%     |
| **Midterm** (in-class)               |    20%     |
| **Final** (cumulative)               |    45%     |
...
-   **Three** homework assignments, completed and submitted **as a team**; **none** are dropped.\
-   Submit on Brightspace before the deadline as a **single** PDF or Word file named **HW_X_Team_Y** (X = homework number, Y = team number), with all relevant Excel (or other) outputs included and clearly referenced.\
-   No late homework or email submissions are accepted without prior permission.\
-   Each team member is expected to understand, for each assignment, the reason for choosing a particular technique, the mechanics of the solution, and the implications of the final recommendation.\
-   If a team member does not contribute, their name should not appear on the submission and they may complete and submit the assignment separately. Teams may not cooperate with other teams; copying or duplicate submissions are considered cheating.

### Midterm

-   **One** in-class midterm exam (20%).\
