...
-   Submit on Brightspace before the deadline as a **single PDF** named **group_NN_hw_X** (NN = your two-digit group number, X = homework number), with all relevant Excel (or other) outputs included and clearly referenced.\
...
-   Homework is **group work**: groups may not cooperate with other groups, and copying or duplicate submissions across groups are considered cheating.\
-   Of this 15%, **3% is the same individual peer evaluation** of your contribution (see **Peer Evaluation** below).

### Peer Evaluation

Because the in-class group cases and the homework are group work, a confidential **peer evaluation** sets the individual portion of those two grades: **5 of the 20 points** for In-Class Group Cases and **3 of the 15 points** for Homework. You complete it near the end of the term through a short Microsoft Forms survey (link on Brightspace), submitting it **once for each teammate** (you do not evaluate yourself).
...
-   **It never changes the group's grade.** Your group's case and homework scores are graded separately; peer evaluation adjusts each member's *own* individual portion, and it can hold steady or go down (a free-rider can lose those points).\
...
-   You rate each teammate 1–10 on four criteria (**contribution, reliability, quality, collaboration**) with a brief, confidential comment.
