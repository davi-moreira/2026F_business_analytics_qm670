...
- **Then write your group contract.** Agree on four things and put them in writing: how you reach each other and how fast you reply; who does what on a case day and on the three homeworks; what the group does when someone goes quiet or misses a deadline; how you settle a disagreement about the call you submit. One page is enough.

- Keep the contract where all of you can see it. At the end of the term your teammates' **confidential peer evaluations** set part of your individual grade, and the contract is the standard you will be reporting against.
...
- **Work with your group.** In-class cases and the three homeworks are both solved and submitted together, one file per group. Explaining a method to a groupmate is the fastest way to learn it.
