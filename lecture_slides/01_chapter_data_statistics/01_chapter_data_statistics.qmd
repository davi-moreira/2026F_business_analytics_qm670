...
author: "Professors<br>Thanh Nguyen<br>Davi Moreira<br>"
#date: "2024-08-01"
...
knitr::include_graphics("figs/thanh.jpg")
```

[nguye161\@purdue.edu](mailto:nguye161@purdue.edu)

<https://sites.google.com/view/thanh-n>
:::

::: {.column style="width: 60%; text-align: center; justify-content: center; align-items: center;"}
-   Lewis B. Cullman Rising Star Professor and Head of the Quantitative Methods Department at Purdue University;

<br>

-   His research covers market design, network economics, and computational social choice, with support from the National Science Foundation and DARPA.

<br>

-   Ph.D. from Cornell University. He teaches QM 67000 and co-developed this course material.
:::
:::::

## Instructor: Davi Moreira
...
[dcordeir\@purdue.edu](mailto:dcordeir@purdue.edu)
...
- **Then write your group contract.** Check your course Brightspace page.
...
::: nonincremental
- **Brightspace is your one channel.** The **syllabus** and **schedule**, every topic's **slides**, the **datasets** to download, announcements, your **group**, the **in-class group cases**, the **three group homeworks**, the exams, and your grades all live there.

- Nothing you need for this course is anywhere else: if you cannot find it on Brightspace, email us.
...
- **Work with your group.** You solve the in-class case together and each of you answers its quiz; the three homeworks are solved and submitted as one file per group. Explaining a method to a groupmate is the fastest way to learn it.
...
::: nonincremental
The class **ends on the Team Sprint**: your group works the case together, then each of you answers the graded Brightspace quiz before you leave. **Today is the exception:** introductions and logistics come first, so the group case is short.
:::
...
::: {.fragment .nonincremental}
- **Every class:** your group works the in-class case and **each of you answers the graded quiz before you leave**.
:::
...
-   **Two cases drive the course:** Vungle A/B (describe → test, Topics 1–9) and auto-parts retail (predict, Topics 10–11). Each class your group also works a separate in-class case and each of you answers its quiz; group homework drills the mechanics.
