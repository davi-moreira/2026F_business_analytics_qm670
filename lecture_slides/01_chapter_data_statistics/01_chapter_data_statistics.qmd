...
- **Find your spot:** each group gathers in a **corner or the center** of the room. I'll call out which group goes where; go there and sit together.

- **Meet your teammates: you have 10 minutes.** Say your name, where you are from, your background, and **one book, film, song, or anything** that tells us something about you.
...
- This course puts **you in the decision-maker's seat**: the **CEO or owner** who has to act. You'll work in a **fixed group** (assigned this week), cracking real cases in class and judging the analysis behind every call.
...
- It turns raw numbers, like Vungle's 30 days of eRPM, into a defensible answer to the CEO's question.
...
- A recommendation is only as good as the data under it, so a sharp CEO looks first. Here is a slice of `vungle_daily.csv`, algorithms interleaved by day:
...
- **One sentence:** today we turned the CEO's question (*roll out B or keep A?*) into a precise data problem, and found B's average eRPM (**\$3.46**) edges A's (**\$3.35**) by **\$0.11**; whether that edge is *real* is the inference question (Topics 7–9).
