...
::: nonincremental
- **Your client (homework):** open your team's case dataset and write its **data audit** (elements, variables, and the type & scale of each), then compute the **mean and median** of its main outcome.
