...
1.  $n$ is large (Central Limit Theorem) or
...
Suppose one wants to develop a 95% confidence interval estimate for the proportion of the population of women golfers satisfied with the availability of tee times, but ensure that the Margin of Error will be equal or lower than 0.025. What is the needed sample size?
...
At 95% confidence $z_{0.025} = 1.96$. Assume $p^* = 0.44$.
