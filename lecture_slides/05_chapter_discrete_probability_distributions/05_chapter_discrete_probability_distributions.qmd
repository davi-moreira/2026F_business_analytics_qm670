...
- So far we have *described* and *compared* data. Today we **model** it: as the CEO you put a **probability distribution** on a random count, then read off the chance of any outcome you care about.
...
- As the CEO you build the machinery in three steps: (1) name the **random variable**, (2) get its **expected value and variance**, (3) recognize it as a **Binomial** and compute exact probabilities in Excel.
