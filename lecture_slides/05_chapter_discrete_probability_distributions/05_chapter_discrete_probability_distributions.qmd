...
**Submit before you leave (graded, one slide per group):** your capacity call for Algorithm A + $E(X)$, $\sigma$, and $P(X \geq 8)$ + the **two things you would challenge** in the analysis.
:::
...
::: nonincremental
- **Homework (individual):** today's tools (the Binomial and Poisson models) are drilled on **HW2** — individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
...
**Submit before you leave (graded, one slide per group):** your pipeline plan for Algorithm A + your $\lambda$, $P(X \geq 8)$, and the chosen capacity $N$ + the **two things you would challenge** in the analysis.
:::
