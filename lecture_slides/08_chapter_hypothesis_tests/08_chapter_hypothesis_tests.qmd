...
**Submit before you leave (graded, one slide per group):** your **fund / don't fund** call for the CFO + your $t$, $p$, and CI + the **two things you would challenge** in the analysis.
:::
...
::: nonincremental
- **Homework (individual):** today's tools (one-sample $t$ and $z$ hypothesis tests) are drilled on **HW3** — individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
...
**Submit before you leave (graded, one slide per group):** your **viable / not viable** call for the ops team + your $z$, $p$, and effect size + the **two things you would challenge** in the analysis.
:::
