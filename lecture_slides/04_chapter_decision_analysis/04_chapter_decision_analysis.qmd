...
## EVPI Step 1: What Would You Do If You Knew?

<br>

Take the states one at a time and ask what Vungle would choose knowing that state for sure. That means reading **down** a column of the payoff table and keeping the best number in it:

::: fragment

| State of nature (prior) | Best choice if you knew | Best payoff |
|---|---|---:|
...
- The oracle's answer **changes** across the two states. Deciding blind, Vungle has to commit to one row and take whichever column shows up; that gap is what EVPI puts a price on.

## EVPI Steps 2 and 3: What the Oracle Is Worth

<br>

Those two best payoffs are what an oracle would hand Vungle. Two lines of arithmetic turn them into a dollar ceiling:

::: fragment

**Step 2, the expected value *with* perfect information:** weight the best payoffs by the priors.
...
**Step 3, subtract what Vungle can expect deciding blind** (\$126.8K, the EV of rolling out B):
