...
**Submit before you leave (graded, one slide per group):** your rollout call (roll out B, keep A, or test) + the **EV / EVPI / EVSI** and the tipping-point prior $p^{*}$ + the **two things you would challenge** in the analysis (e.g. the −160 downside, the priors).
:::
...
::: nonincremental
- **Homework (individual):** today's tools (payoff tables, decision trees, expected value, and EVPI/EVSI) are drilled on **HW1** — individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
