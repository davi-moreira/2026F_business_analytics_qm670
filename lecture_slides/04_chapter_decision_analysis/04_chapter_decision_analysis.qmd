...
- Today you put on the **CEO's hat**: given that uncertainty, what is the right **action**?

## The Brief: Today's CEO Question
...
- This is exactly why a CEO also asks: *what would it be worth to know the true state before deciding?* That question has a precise answer: **EVPI**.
...
- **Next time:** modeling **uncertain counts** (how many installs tomorrow?) with discrete probability distributions, the raw material priors and payoffs are built from.
:::
