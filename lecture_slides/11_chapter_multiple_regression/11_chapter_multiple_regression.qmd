...
**What you'll use:** the overall **$F$-test** vs. the individual **$t$-tests**, a **dummy** variable, and a **VIF** check, then translate the coefficients into a budget call. **Excel:** Analysis ToolPak → Regression.
