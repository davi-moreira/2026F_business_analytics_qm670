...
**Submit before you leave (graded, one slide per group):** your read of what each driver is worth (the equation + $R^2$ vs. adjusted $R^2$ + the Yelp and endcap dollar figures) and the **two things you would challenge** in this fit.
:::
...
::: nonincremental
- **Homework (individual):** today's tools (multiple regression, the $F$ vs. $t$ tests, and dummy variables) are drilled on **HW3** — individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
...
**Submit before you leave (graded, one slide per group):** your CFO recommendation (which lever to fund) + the key numbers (Significance F, the significant-vs-not verdict, the endcap's dollar value) + the **two things you would challenge** in the analysis.
:::
