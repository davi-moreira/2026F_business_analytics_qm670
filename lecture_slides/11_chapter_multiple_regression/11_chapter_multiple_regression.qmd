...
A simple random sample is used to compute sample intercept and slopes $b_0, b_1, b_2, \dots, b_p$ that are used as the point estimators of the population intercept and slopes $\beta_0, \beta_1, \beta_2, \dots, \beta_p$.
