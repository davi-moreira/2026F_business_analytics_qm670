...
## Do It in Excel: Multiple Regression (Butler)

:::::: columns
::: {.column width="46%"}
**Follow along:**

1. Lay miles and deliveries in **two side-by-side columns**.
2. **Data → Data Analysis → Regression**.
3. Input Y Range: the travel-time column; Input X Range: **both** predictor columns together.
4. Check **Labels** and **Confidence Level 95%**; click OK.
5. Read the **Coefficients** column: $b_0 = -0.869$, $b_1 = 0.0611$, $b_2 = 0.923$.
:::
::: {.column width="54%"}
![](figs/excel_reg_butler_coefs.png){.nostretch fig-align="center" width="100%"}
...
1. Put the **four predictor columns contiguous** (`population_3mi`, `income_3mi`, `yelp_rating`, `endcap`).
2. **Data → Data Analysis → Regression**.
3. Input Y Range: `sales2012_k`; Input X Range: all **four** columns selected together.
4. Check **Labels** and **Confidence Level 95%**; click OK.
...
:::
::: {.column width="54%"}
![](figs/excel_reg_butler_anova.png){.nostretch fig-align="center" width="100%"}
:::
::::::
