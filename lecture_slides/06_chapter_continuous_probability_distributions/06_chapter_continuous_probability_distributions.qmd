...
**Submit before you leave (graded, one slide per group):** your call on whether Normal is a sensible model for B's eRPM + the key numbers ($\bar{x}$, $s$, the 95% empirical interval, the $z$ for \$3.50) + the **two things you would challenge** in the fit.
:::
...
**Submit before you leave (graded, one slide per group):** your verdict on whether to trust the Normal model + the key numbers ($P(\text{eRPM} > \$3.50)$, the 90th-percentile eRPM, the QQ-plot read) + the **two things you would challenge** in the analysis.
:::
