...
- **How today's studio runs:** I demo each idea on a textbook example, then your group reproduces and interrogates the fitted Normal on the in-class group case, then we debrief what the model can and cannot tell the CEO.
...
- One dataset, one bell curve, and from it every probability and percentile the CEO needs.
...
- **The big call (Vungle A/B):** roll out B, or stay with A? Today's piece for the CEO: **what's the chance of a high or low value (and can we fit a Normal to it)?**
...
- **The big call (Vungle A/B):** roll out B, or stay with A? Today's piece for the CEO: **what probability and percentile does the Normal give, and is the model fair?**
...
- **Homework (individual):** HW2 drills the Normal model, z-scores, and percentiles (previous-edition problem sets on Brightspace).
