...
- **Today's piece of that call:** *is B's edge steady, or just more volatile?* As Vungle's CEO, you cannot bet the company on an average that hides wild day-to-day swings.
...
- By the end, your team turns these into a **one-screen A-vs-B dashboard**, the CEO's first honest read.
...
- **Vungle read:** even before testing, CV tells you which algorithm is *relatively* more volatile, exactly the risk question you, the CEO, care about.
...
- **One number to remember:** **CV**. Algorithm B's spread is **10% of its mean** vs. A's 6.5%; that is the risk you, the CEO, must weigh against the \$0.11 reward.
