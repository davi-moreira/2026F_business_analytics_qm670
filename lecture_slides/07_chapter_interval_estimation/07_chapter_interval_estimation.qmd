...
- This is a **two-lecture** topic. Each lecture runs the same loop: **the Brief (your decision) → Method Studio (I demo on Vungle) → Debrief (we land the call) → Team Sprint (your group case, its quiz answered before you leave).**
