...
**Submit before you leave (graded, one slide per group):** your site-scoring call (would you use Yelp rating?) + the equation, the dollars-per-star number, and $R^2$ + the **two things you would challenge** in the analysis.
:::
...
::: nonincremental
- **Homework (individual):** today's tools (simple linear regression) are drilled on **HW3**, individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
...
**Submit before you leave (graded, one slide per group):** your lease-memo call (the 4.5-star forecast + which interval you'd quote) + the slope verdict with its 95% CI and an assumptions one-liner + the **two things you would challenge** in the analysis.
:::
...
::: nonincremental
- **Homework (individual):** today's tools (testing the slope, residual checks, and prediction intervals) are drilled on **HW3**, individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
...
::: nonincremental
- **Homework (individual):** the full simple-regression arc (fit, interpret, test, validate, forecast) is drilled on **HW3**, individual problem sets in the previous-edition format, posted on Brightspace. Run them yourself so you can check an analyst who uses them.
